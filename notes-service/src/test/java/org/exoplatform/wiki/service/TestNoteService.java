...
public class TestNoteService extends BaseTest {
  ...
  public void setUp() throws Exception {
    ...
    getOrCreateWiki(wikiService, PortalConfig.PORTAL_TYPE, PORTAL_NAME);
  ...
  public void testGetGroupPageById() throws WikiException, IllegalAccessException {
    Wiki wiki = getOrCreateWiki(wikiService, PortalConfig.GROUP_TYPE, USERS_GROUP);
  ...
  public void testGetUserPageById() throws WikiException, IllegalAccessException {
    Wiki wiki = getOrCreateWiki(wikiService, PortalConfig.USER_TYPE, "john");
  ...
  public void testMoveNote() throws WikiException, IllegalAccessException {
    ...
    Wiki demoWiki = getOrCreateWiki(wikiService, PortalConfig.USER_TYPE, "root");
  ...
  public void testUpdateNote() throws WikiException, IllegalAccessException, Exception {
    Identity root = ROOT_IDENTITY;
    // Get Home
    getOrCreateWiki(wikiService, PortalConfig.PORTAL_TYPE, PORTAL_NAME).getWikiHome();
  ...
  public void testDraftPage() throws WikiException, IllegalAccessException {
    ...
    DraftPage updatedDraftOfNewPage = noteService.updateDraftForNewPage(draftOfNewPage,
                                                                        now,
  ...
  public void testImportNotes() throws Exception {
    Wiki portalWiki = getOrCreateWiki(wikiService, PortalConfig.PORTAL_TYPE, PORTAL_NAME);
    assertThrows(IllegalAccessException.class,
                 () -> noteService.createNote(portalWiki, "Home", new Page("to_be_imported1", "to_be_imported1"), USER_IDENTITY));
  ...
  public void testGetNotesOfWiki() throws WikiException, IllegalAccessException {
    ...
    Page toBeImported1NotPage = noteService.createNote(portalWiki,
                                                       "Home",
                                                       new Page("to_be_imported1", "to_be_imported1"),
                                                       ROOT_IDENTITY);
    Page toBeImported2NotPage = noteService.createNote(portalWiki,
                                                       "Home",
                                                       new Page("to_be_imported2", "to_be_imported2"),
                                                       ROOT_IDENTITY);
    Page toBeImported3NotPage = noteService.createNote(portalWiki,
                                                       "Home",
                                                       new Page("to_be_imported3", "to_be_imported3"),
                                                       ROOT_IDENTITY);
  ...
  public void testDeleteVersionsByNoteIdAndLang() throws Exception {
    ...
    Wiki portalWiki = getOrCreateWiki(wikiService, PortalConfig.GROUP_TYPE, space.getGroupId());
  ...
  public void testRemoveOrphanDraftPagesByParentPage() throws Exception {
    startSessionAs("root");
    Wiki portalWiki = getOrCreateWiki(wikiService, PortalConfig.GROUP_TYPE, USERS_GROUP);
  ...
  private Page createTestNoteWithVersionLang(String name, String lang, Identity user) {
    ...
    Wiki spaceWiki = getOrCreateWiki(wikiService, PortalConfig.GROUP_TYPE, space.getGroupId());
  ...
  public void testSaveNoteFeaturedImage() throws Exception {
    ...
    NotePageProperties properties = noteService.saveNoteMetadata(notePageProperties,
                                                                 null,
                                                                 getIdentityId(ROOT_IDENTITY.getUserId()));
  ...
  public void testFeaturedImageWhenRemoveDraftById() throws Exception {
    ...
    NoteFeaturedImage featuredImage =
                                    noteService.getNoteFeaturedImageInfo(Long.valueOf(draftPage.getId()),
                                                                         null,
                                                                         true,
                                                                         null,
                                                                         getIdentityId(ROOT_IDENTITY.getUserId()),
    ...
    draftPage.setProperties(notePageProperties);
    draftPage = noteService.createDraftForExistPage(draftPage, note, null, new Date().getTime(), "root");
    featuredImage = noteService.getNoteFeaturedImageInfo(Long.valueOf(draftPage.getId()),
                                                         null,
                                                         true,
                                                         null,
                                                         getIdentityId(ROOT_IDENTITY.getUserId()),
  ...
  public void testGetDraftsOfWiki() throws Exception {
    ...
    Page note2 =
               noteService.createNote(portalWiki, "Home", new Page("testGetDraftsOfWiki", "testGetDraftsOfWiki"), ROOT_IDENTITY);
    DraftPage draftPage = new DraftPage();
    draftPage.setTitle("test");
    draftPage.setContent("test");
  ...
  public void testSaveHideAuthorAndHideReactionProperties() throws Exception {
    ...
    // original note properties values in case of shared original properties
    // values
