...
public interface NoteService {
   ...
   * @return latest draft of the given page
   * @throws WikiException
   * @Deprecated Use {@link getLatestDraftOfPage(Page targetPage)} instead
   */
  @Deprecated
   ...
   * @return The list of children notes
   * @throws WikiException if an error occured
   * @Deprecated Use {@link getChildrenNoteOf(Page note, boolean withDrafts,
   *             boolean withChild)} instead
   */
  @Deprecated
   ...
   * @return The list of duplicated notes.
   * @throws WikiException if an error occured
   * @Deprecated Use {@link getDuplicateNotes(Page parentNote, Wiki
   *             targetNoteBook, List<Page> resultList)} instead
   */
  @Deprecated
   ...
   * @throws WikiException if an error occured
   * @Deprecated Use {@link removeDraftOfNote(Page page)} instead
   */
  @Deprecated
   ...
   * @return the list of children of the note to export
   * @throws WikiException
   * @Deprecated Use {@link getChildrenNoteOf(NoteToExport note)} instead
   */
  @Deprecated
   ...
   * @param withDrafts if set to true returns languages draft notes
   * @return {@link List} of {@link String}
   * @Deprecated Use {@link getPageAvailableTranslationLanguages(Long pageId,
   *             boolean withDrafts)} instead
   */
  @Deprecated
   ...
   * @param lang content language
   * @return {@link DraftPage}
   * @Deprecated Use {@link getLatestDraftPageByTargetPageAndLang(Long
   *             targetPageId, String lang)} instead
   */
  @Deprecated
   ...
   * @param username owner username
   * @throws WikiException if an error occured
   * @Deprecated Use {@link deleteVersionsByNoteIdAndLang(Long noteId, String
   *             lang)} instead
   */
  @Deprecated
