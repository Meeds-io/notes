...
public class MailTemplateProvider extends TemplateProvider {
    ...
    protected class TemplateBuilder extends AbstractTemplateBuilder {
        ...
        protected MessageInfo makeMessage(NotificationContext ctx) {
            ...
            templateContext.put(MentionInNoteNotificationPlugin.NOTE_TITLE.getKey(), encoder.encode(notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.NOTE_TITLE.getKey())));
            templateContext.put(MentionInNoteNotificationPlugin.NOTE_AUTHOR.getKey(), encoder.encode(notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.NOTE_AUTHOR.getKey())));
            templateContext.put(MentionInNoteNotificationPlugin.CURRENT_USER.getKey(), notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.CURRENT_USER.getKey()));
            templateContext.put(MentionInNoteNotificationPlugin.AUTHOR_AVATAR_URL.getKey(), encoder.encode(notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.AUTHOR_AVATAR_URL.getKey())));
            templateContext.put(MentionInNoteNotificationPlugin.AUTHOR_PROFILE_URL.getKey(), encoder.encode(notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.AUTHOR_PROFILE_URL.getKey())));
            templateContext.put(MentionInNoteNotificationPlugin.ACTIVITY_LINK.getKey(), encoder.encode(notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.ACTIVITY_LINK.getKey())));

            templateContext.put("READ",
                    Boolean.valueOf(notification.isRead()) ? "read"
                            : "unread");
        ...
        protected String buildDigestMsg(List<NotificationInfo> notifications, TemplateContext templateContext) {
            ...
            for (NotificationInfo notification : notifications) {
                templateContext.put(MentionInNoteNotificationPlugin.NOTE_TITLE.getKey(), notification.getValueOwnerParameter(MentionInNoteNotificationPlugin.NOTE_TITLE.getKey()));
